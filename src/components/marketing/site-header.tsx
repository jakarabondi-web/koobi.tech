...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border/70 bg-background/85 backdrop-blur supports-[backdrop-filter]:bg-background/70">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:h-24 sm:px-6 lg:h-40 lg:px-8">
        <Link href="/" className="flex items-center gap-2 text-xl font-extrabold tracking-tight sm:gap-3 sm:text-3xl lg:gap-4 lg:text-5xl">
          <LogoMark size={120} priority className="size-9 sm:size-16 lg:size-[120px]" />
          {brand.name}
        </Link>
